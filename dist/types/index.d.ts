...
export declare type MapActionsType<State, StoreOptionsImpl extends StoreOptions<State>> = <Actions extends Record<string, keyof UnpackActions<"", State, any, StoreOptionsImpl>> | Array<keyof UnpackActions<"", State, any, StoreOptionsImpl>>>(actions: Actions) => Actions extends Record<string, keyof UnpackActions<"", State, any, StoreOptionsImpl>> ? {
    [TActionKey in keyof Actions]: (payload?: PropType<UnpackActions<"", State, any, StoreOptionsImpl>[Actions[TActionKey]], "payload">, dispatchOptions?: DispatchOptions) => PropType<UnpackActions<"", State, any, StoreOptionsImpl>[Actions[TActionKey]], "returnType">;
} : Actions extends Array<keyof UnpackActions<"", State, any, StoreOptionsImpl>> ? {
    [T in Actions[0]]: (payload?: PropType<PropType<UnpackActions<"", State, any, StoreOptionsImpl>, T>, "payload">, dispatchOptions?: DispatchOptions) => PropType<PropType<UnpackActions<"", State, any, StoreOptionsImpl>, T>, "returnType">;
} : any;
export declare type MapStateType<State, StoreOptionsImpl extends StoreOptions<State>> = <States extends (Record<string, (state: UnpackState<State, NonNullable<PropType<StoreOptionsImpl, "modules">>>) => any> | Record<string, keyof UnpackState<State, NonNullable<PropType<StoreOptionsImpl, "modules">>>> | Array<keyof UnpackState<State, NonNullable<PropType<StoreOptionsImpl, "modules">>>>)>(states: States) => States extends Record<string, (state: UnpackState<State, NonNullable<PropType<StoreOptionsImpl, "modules">>>) => any> ? {
...
export declare type MapGettersType<State, StoreOptionsImpl extends StoreOptions<State>> = <Getters extends Record<string, keyof UnpackGetters<"", State, any, StoreOptionsImpl>> | Array<keyof UnpackGetters<"", State, any, StoreOptionsImpl>>>(getters: Getters) => Getters extends Record<string, keyof UnpackGetters<"", State, any, StoreOptionsImpl>> ? {
    [TGetterKey in keyof Getters]: UnpackGetters<"", State, any, StoreOptionsImpl>[Getters[TGetterKey]];
} : Getters extends Array<keyof UnpackGetters<"", State, any, StoreOptionsImpl>> ? {
    [T in Getters[0]]: (payload?: PropType<PropType<UnpackGetters<"", State, any, StoreOptionsImpl>, T>, "payload">, commitOptions?: CommitOptions) => void;
} : any;
export declare type MapMutationsType<State, StoreOptionsImpl extends StoreOptions<State>> = <Mutations extends Record<string, keyof UnpackMutations<"", State, any, StoreOptionsImpl>> | Array<keyof UnpackMutations<"", State, any, StoreOptionsImpl>>>(muations: Mutations) => Mutations extends Record<string, keyof UnpackMutations<"", State, any, StoreOptionsImpl>> ? {
    [TMutationKey in keyof Mutations]: (payload?: PropType<UnpackMutations<"", State, any, StoreOptionsImpl>[Mutations[TMutationKey]], "payload">, commitOptions?: CommitOptions) => void;
} : Mutations extends Array<keyof UnpackMutations<"", State, any, StoreOptionsImpl>> ? {
    [T in Mutations[0]]: (payload?: PropType<PropType<UnpackMutations<"", State, any, StoreOptionsImpl>, T>, "payload">, commitOptions?: CommitOptions) => void;
} : any;
export {};
