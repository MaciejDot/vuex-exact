...
declare type UnpackActionGroup<Prefix extends string, Impl> = {
...
declare type UnpackActionModule<T extends keyof PropType<Impl, "modules">, Prefix extends string, Impl> = PropType<Impl, "modules"> extends undefined ? UnpackActionGroup<Prefix, Impl> : keyof PropType<Impl, "modules"> extends never ? UnpackActionGroup<Prefix, Impl> : UnpackActionGroup<Prefix, Impl> & UnpackActions<T extends string ? `${Prefix}${T}/` : "", PropType<PropType<Impl, "modules">, T>>;
export declare type UnpackActions<Prefix extends string, Impl extends any> = UnpackActionModule<keyof PropType<Impl, "modules">, Prefix, Impl>;
export {};
