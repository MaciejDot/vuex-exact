...
type UnpackMutationGroup<Prefix extends string, Impl> =
    {
...
type UnpackMutationsModule<T extends keyof PropType<Impl, "modules">, Prefix extends string, Impl>
    =
    PropType<Impl, "modules"> extends undefined ?
    UnpackMutationGroup<Prefix, Impl> :
    keyof PropType<Impl, "modules"> extends never ?

    UnpackMutationGroup<Prefix,  Impl> :
    UnpackMutationGroup<Prefix, Impl> & UnpackMutations<
        T extends string ?
        `${Prefix}${T}/` : "",
        PropType<PropType<Impl, "modules">, T>>

export type UnpackMutations<Prefix extends string, Impl> =
    UnpackMutationsModule<keyof PropType<Impl, "modules">, Prefix, Impl>
